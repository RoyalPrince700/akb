        ...
        <div className="relative">
          ...
          <p className="mb-6 leading-relaxed text-slate-600">
            {isHrLock ? (
              <>
                This assessment for{" "}
                <strong className="text-slate-800">{courseTitle}</strong> is
                currently locked by HR. You will be able to take it once it is
                unlocked.
              </>
            ) : (
              <>
                This assessment is locked because you have not completed the{" "}
                <strong className="text-slate-800">{courseTitle}</strong> course
                yet. Finish all chapters in that course to unlock the assessment.
              </>
            )}
          </p>
