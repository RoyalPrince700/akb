...
const HrKssAttendanceDetailPage = () => {
  const { id } = useParams();
  const { user } = useAuth();
  const panelRole = user?.role === "admin" ? "admin" : "hr";
  const listPath = panelSegmentPath(panelRole, "kss-attendance");
                ...
                <table className="w-full min-w-[560px] text-left text-sm">
                  <thead>
                    <tr className="border-b border-slate-200 text-slate-500">
                      ...
                      <th className="px-3 py-3 font-medium">Marked at</th>
                    </tr>
                  </thead>
                  <tbody>
                    {attendees.length === 0 ? (
                      <tr>
                        ...
                        >
                          No one has marked attendance yet. Share the link with
                          staff.
                        </td>
                      </tr>
                    ) : (
                      attendees.map((attendee) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-3 text-slate-600">
                            {formatDateTime(attendee.markedAt)}
                          </td>
                        </tr>
                      ))
                    )}
...
export default HrKssAttendanceDetailPage;
